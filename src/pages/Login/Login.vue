        ...
        <form @submit.prevent="login">
          ...
          <div :class="{on:!loginWay}" >
            <section>
              ...
              <section class="login_verification">
                <input type="tel" maxlength="8" placeholder="密码" v-if="show" v-model="pwd">
                <input type="password" maxlength="8" placeholder="密码" v-else v-model="pwd">
                <div class="switch_button off" @click="show=!show" :class="show?'on':'off'">
                  <div class="switch_circle" :class="{right:show}"></div>
